 ...
 */
    public class LocalDevice
    {
        ...
        internal LocalDevice(uint deviceId, ApplicationLayer applicationLayer, string deviceName, string modelName)
        {
        ...
        //{
        //    return applicationLayer.getNetwork().getAllLocalAddresses();
        //}

        internal IAmRequest getIAm()
        {
            try
            {
